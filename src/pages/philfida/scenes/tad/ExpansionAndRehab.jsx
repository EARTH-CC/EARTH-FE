...
import DownloadFunction from "../../../../components/philfida/Buttons/DownloadFunctions/ExpansionAndRehab";
    ...
    <PageContainer>
      <Grid container spacing={0}>
        <Grid item xs={10} sx={{ display: "flex", alignItems: "center" }}>
          <LiaBaconSolid style={{ fontSize: "80px" }} />
          <Typography sx={{ fontWeight: "bold", fontSize: "20px", ml: 2 }}>
            FIBER CROPS EXPANSION AND REHABILITATION REPORTS
          </Typography>
        </Grid>
        <Grid
          item
        ...
        >
          <DownloadTemplateButton templateName="Expansion_and_Rehabilitation_Template" />
        </Grid>
      </Grid>
      <Grid container spacing={0}>
        <Grid
        ...
        >
          ...
          <Grid container>
            ...
            >
              ...
              >
                Expansion and Rehabilitation (Area Planted and No. of Planted
                PM)
              </Typography>
          ...
          <Box sx={{ mb: 1 }}>
            <MixChart
              ...
              barChartLegend="No. of Planted PM"
