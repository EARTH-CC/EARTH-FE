...
import DownloadFunction from "../../../../components/philfida/Buttons/DownloadFunctions/Cotton";
    ...
    <PageContainer>
      <Grid container spacing={0}>
        <Grid item xs={10} sx={{ display: "flex", alignItems: "center" }}>
          <TiWeatherWindyCloudy style={{ fontSize: "80px" }} />
          <Typography sx={{ fontWeight: "bold", fontSize: "20px", ml: 2 }}>
            COTTON PRODUCTION REPORTS
          </Typography>
        </Grid>
        <Grid
          item
        ...
        >
          <DownloadTemplateButton templateName="Cotton_Template" />
        </Grid>
      </Grid>
      <Grid container spacing={0}>
        <Grid
        ...
        >
          ...
          <Grid container>
            ...
            >
              ...
              >
                Cotton Production (Area Planted)
              </Typography>
