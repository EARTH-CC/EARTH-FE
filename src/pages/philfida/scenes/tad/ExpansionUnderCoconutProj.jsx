...
import DownloadFunction from "../../../../components/philfida/Buttons/DownloadFunctions/ExpansionUnderCocoProj";
...
export default function CoconutProject() {
    ...
    <PageContainer>
      <Grid container spacing={0}>
        <Grid item xs={10} sx={{ display: "flex", alignItems: "center" }}>
          <PiTreePalmBold style={{ fontSize: "80px" }} />
        ...
        >
          <DownloadTemplateButton templateName="Cocoon_Template" />
        </Grid>
      </Grid>
      <Grid container spacing={0}>
        <Grid
        ...
        >
          ...
          <Grid container>
            ...
            >
              ...
              >
                Expansion Under Coconut Project (Area Planted)
              </Typography>
          ...
          <Box sx={{ mb: 1 }}>
            <MixChart
              ...
              decimal={decimal}
              lineChartLegend="Area Planted"
              barChartLegend="Area Planted"
