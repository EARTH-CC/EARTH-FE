...
export default function DiseaseManagementProj() {
  ...
  const moduleName = "abacadiseasemanagement";
    ...
    <PageContainer>
      <Grid container spacing={0}>
        <Grid item xs={10} sx={{ display: "flex", alignItems: "center" }}>
          <TbVirusOff style={{ fontSize: "80px" }} />
          <Typography sx={{ fontWeight: "bold", fontSize: "20px", ml: 2 }}>
            ABACA DISEASE MANAGEMENT PROJECT REPORTS
          </Typography>
        </Grid>
        <Grid
          item
        ...
        >
          <DownloadTemplateButton templateName="Abaca_Disease_Management_Template" />
        </Grid>
      </Grid>
      <Grid container spacing={0}>
        <Grid
        ...
        >
          ...
          <Grid container>
            ...
            >
              ...
              >
                Abaca Disease Management Project (Area Treated and Disease
                Percentage)
              </Typography>
          ...
          <Box sx={{ mb: 1 }}>
            <MixChart
              ...
              decimal={decimal}
              lineChartLegend="Area Treated"
              barChartLegend="Disease Percentage"
