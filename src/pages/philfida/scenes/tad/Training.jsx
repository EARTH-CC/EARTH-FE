...
import DownloadFunction from "../../../../components/philfida/Buttons/DownloadFunctions/Training";
  ...
  return (
    <PageContainer>
      <Grid container spacing={0}>
        ...
        >
          <DownloadTemplateButton templateName="Training_Template" />
        </Grid>
      </Grid>
      <Grid container spacing={0}>
        <Grid
        ...
        >
          ...
          <Grid container>
            ...
            >
              ...
              >
                Conduct of Training (Participants)
              </Typography>
          ...
          <Box sx={{ mb: 1 }}>
            <MixChart
              ...
              decimal={decimal}
              lineChartLegend="Participant's Name"
              barChartLegend="Participant's Gender"
