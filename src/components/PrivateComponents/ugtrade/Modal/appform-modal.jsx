...
import SelectEligibility from "components/philfida/Textfields/select-eligibility";
import AttachFileButton from "components/philfida/Buttons/AttachFileButton";
import Logo from "../../../assets/philfida.png";
import AppFormValidation, { initialAppForm } from "../../../validation/appform";
...
function AppForm({ open, handleClose }) {
  ...
  const formik = useFormik({
    ...
    validationSchema: AppFormValidation,
    onSubmit: () => {
      setError("");
      setLoading(true);
